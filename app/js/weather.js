...
function getWeatherData(zip){
	...
	var url =  'http://api.aerisapi.com/forecasts/rochester,ny?filter=1hr&limit=999&client_id=btq5TOAD6ArvUjPYuyebw&client_secret=I4hUZsjsJKEvzZNM7ZC8tqAoqesCjwY0EzaQ0a78';
	$.ajax({
	  dataType: "json",
	  url: url,
	  data: null,
